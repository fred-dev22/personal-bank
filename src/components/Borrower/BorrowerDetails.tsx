...
export const BorrowerDetails: React.FC<BorrowerDetailsProps> = ({ borrower, loans, onBack, onShowLoanDetails }) => {
  console.log('!!! BorrowerDetails ACTIF !!!');
  ...
  console.log('filteredLoans:', filteredLoans.map(l => ({ id: l.id, nickname: l.nickname })));
            ...
            <section className="borrower-loans">
              ...
              {filteredLoans.length === 0 ? (
                ...
                <Table
                  ...
                  data={filteredLoans}
                  onRowClick={onShowLoanDetails ? (row: Loan) => (onShowLoanDetails as (id: string) => void)(row.id) : undefined}
                  clickableRows={true}
